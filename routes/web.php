...
Route::group(['prefix' => 'api', 'middleware' => ['auth', 'setTenant']], function () {
    Route::group(['prefix' => 'search'], function () {
        ...
        Route::get('task_types', 'TaskTypeController@search');
        Route::get('task_statuses', 'TaskStatusController@search');
    ...
    Route::group(['prefix' => 'mark-as'], function () {
        ...
        Route::post('tasks/{task}', 'TaskController@markAs');
    });
    ...
    Route::group(['prefix' => 'settings'], function () {
        ...
        Route::get('tasks', 'TaskSettingsController@show');
        Route::post('tasks', 'TaskSettingsController@update');
    ...
    Route::post('overview', 'OverviewController@save');
});
...
Route::get('{vue?}', 'PageController@index')->middleware('setTenant')->where('vue', '[\/\w\.-]*')
    ->name('app');
