<template>
    <div class="content-inner" v-if="show">
        <x-panel margin padding>
            ...
            <x-row line>
                <x-form-group :errors="errors.default_expense_category_id" :label="$t('default_expense_category_id')"
                              col="4">
                    <x-tag-input :value="form.default_expense_category" @input="value => { form.default_expense_category_id = value.id; form.default_expense_category = value }" column="name"
                                 name="name"
        ...
        <mini-crud title="expense_categories"
                   url="settings/expense_categories">
            <x-tr slot="heading">
