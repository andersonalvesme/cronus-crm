<template>
    <div>
        <x-button :disabled="disabled" @click="toggleExport" class="w-xs">
            {{$t('export')}}
        </x-button>
        <x-modal @close="toggleExport" v-if="show" width="400">
            <div slot="title">{{$t('export')}} ({{total}}) {{$t('entries')}}</div>
            <x-row>
                <x-col span="12">
                    <a :disabled="showForm" :href="url" @click="toggleExport" class="export-link">
            ...
            <div class="export-recurring" v-if="showForm">
                <div class="form-group">
                    ...
                    <small class="invalid-feedback" v-if="errors.email_to">
                        {{errors.email_to[0]}}
                    </small>
                </div>
                <x-row>
                    <x-col span="8">
                        <div class="form-group">
                            ...
                            <small class="invalid-feedback" v-if="errors.frequency">
                                {{errors.frequency[0]}}
                            </small>
                        </div>
                    </x-col>
                    <x-col span="8" v-if="form.frequency === 'weekly'">
                        <div class="form-group">
                            ...
                            <select class="form-select" v-model="form.send_on">
                            ...
                            <small class="invalid-feedback" v-if="errors.send_on">
                                {{errors.send_on[0]}}
                            </small>
                        </div>
                    </x-col>
                    ...
                    <x-col span="8">
                        <div class="form-group">
                            <label class="form-label">{{$t('send_at')}}</label>
                            <select class="form-select" v-model="form.send_at">
                            ...
                            <small class="invalid-feedback" v-if="errors.send_at">
                                {{errors.send_at[0]}}
                            </small>
                        </div>
                    </x-col>
            ...
            <template slot="footer">
                ...
                <div>
                    ...
                    <x-button :loading="isProcessing" @click="onSave" type="primary" v-if="showForm">
                        {{this.$t('create')}}
                    </x-button>
                </div>
            </template>
