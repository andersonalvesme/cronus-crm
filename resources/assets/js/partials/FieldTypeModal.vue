    ...
    <x-modal @cancel="$emit('cancel')">
        <div slot="title">
            ...
            <div class="flex flex-center" v-else-if="activeTab === 'field'">
                <x-button @click="activeTab ='menu'" class="mr-1" icon="arrow-left" size="sm"></x-button>
        ...
        <div>
            <x-simple-tab :active="activeTab" :tabs="availableTabs">
                <div class="btn-list" slot="menu">
                    <template v-for="type in types">
                        <x-button @click="selectType(type)" class="w-xs">
                            {{type.title}}
                        </x-button>
                    </template>
                </div>
                <div slot="field">
                    <x-simple-tab :active="activeType && activeType.name"
                        ...
                        <text-type :form="form" :tabs="activeType && activeType.tabs" slot="number"
                                   type="number"></text-type>
                        <textarea-type :form="form" :tabs="activeType && activeType.tabs"
                                       slot="textarea"></textarea-type>
                        ...
                        <currency-type :form="form" :tabs="activeType && activeType.tabs"
                                       slot="currency"></currency-type>
        ...
        <template slot="footer">
            <x-button @click="$emit('cancel')" class="w-xs mr-auto">{{$t('cancel')}}</x-button>
            <x-button @click="addField" class="float-right w-xs" type="primary" v-if="activeTab !=='menu'">
