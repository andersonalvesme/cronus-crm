					...
					<x-col span="16" v-if="form.thead[active]">
						<x-row>
							...
							<x-form-group col="10" :label="$t('column_type')">
								<select class="form-select" v-model="form.thead[active].type">
						...
						<x-row v-if="form.thead[active].type !=='hidden'">
							<x-form-group col="8" :label="$t('width')">
								<select class="form-select" v-model="form.thead[active].width">
									<option v-for="x in 24" :value="x">{{x}}</option>
								</select>
							</x-form-group>
							<x-form-group col="8" :label="$t('align')">
								<select class="form-select" v-model="form.thead[active].align">
						...
						<x-row v-if="form.thead[active].type === 'select'">
							<x-col span="12">
								<div class="form-group">
									...
									<div class="form-list" v-for="(m, i) in form.thead[active].options">
									  <input type="text" class="form-control" :placeholder="`Option ${i + 1}`" v-model="form.thead[active].options[i]">
							...
							<x-col span="12">
								<div class="form-group">
									...
									<select class="form-select" v-model="form.thead[active].default">
						...
						<x-row v-else>
							<x-col span="12">
								<div class="form-group">
									...
									<input v-if="['text', 'date', 'number'].includes(form.thead[active].type)"
										:type="form.thead[active].type" class="form-control" v-model="form.thead[active].default">
									<input v-else-if="['currency', 'computed_currency', 'computed', 'hidden'].includes(form.thead[active].type)"
										type="number" class="form-control" v-model="form.thead[active].default">
									<textarea v-else-if="form.thead[active].type === 'textarea'" class="form-control" v-model="form.thead[active].default"></textarea>
							...
							<x-col span="6" v-if="form.thead[active].type === 'date'">
								<div class="form-group">
									...
									<select class="form-select" v-model="form.thead[active].format">
						...
						<x-row v-if="['computed_currency', 'computed', 'hidden'].includes(form.thead[active].type)">
							<x-col span="6">
								<div class="form-group">
									...
									<select class="form-select" v-model="form.thead[active].formula">
				...
				<x-row>
					...
					<x-col span="16" v-if="form.tfoot[af]">
						<x-row>
							...
							<x-form-group col="10" :label="$t('column_type')">
								<select class="form-select" v-model="form.tfoot[af].type">
						...
						<x-row v-if="form.tfoot[af].type !=='hidden'">
							<x-form-group col="8" :label="$t('align')">
								<select class="form-select" v-model="form.tfoot[af].align">
									<option v-for="x in ['left', 'center', 'right']" :value="x">{{$t(x)}}</option>
								</select>
							</x-form-group>
						</x-row>
						...
						<x-row>
							<x-col span="12">
								<div class="form-group">
									...
									<input type="number" class="form-control" v-model="form.tfoot[af].model">
								</div>
							</x-col>
						</x-row>
						<x-row v-if="['computed_currency', 'computed', 'hidden'].includes(form.tfoot[af].type)">
							<x-col span="6">
								<div class="form-group">
									...
									<select class="form-select" v-model="form.tfoot[af].formula">
						...
						<x-row v-else-if="['aggregate', 'aggregate_currency'].includes(form.tfoot[af].type)">
							...
							<x-col span="16">
								<div class="form-group">
									...
									<select class="form-select" v-model="form.tfoot[af].tbody_column">
						...
						<x-row v-else-if="['tax'].includes(form.tfoot[af].type)">
							<x-col span="6">
								<div class="form-group">
									...
									<input type="number" class="form-control" v-model="form.tfoot[af].percent_model">
								</div>
							</x-col>
							<x-col span="8">
								<div class="form-group">
									<label class="form-label">{{$t('select_sub_total')}}</label>
									<select class="form-select" v-model="form.tfoot[af].sub_total">
			...
			<div slot="invoice">
				<x-row>
		  		<x-form-group col="8" :label="$t('sub_total')">
		  			<select class="form-select" v-model="form.invoice.sub_total">
		  				<option v-for="f in form.tfoot" :value="f.name">{{f.title}}</option>
		  			</select>
		  		</x-form-group>
		  		<x-form-group col="8" :label="$t('grand_total')">
		  			<select class="form-select" v-model="form.invoice.grand_total">
		  				<option v-for="f in form.tfoot" :value="f.name">{{f.title}}</option>
		  			</select>
		  		</x-form-group>
				</x-row>
