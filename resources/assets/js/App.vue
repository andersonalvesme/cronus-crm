      ...
      <header class="navbar navbar-expand-md navbar-light d-none d-lg-flex">
        <div class="container-xl">
          ...
          <div class="navbar-nav flex-row order-md-last">
            <div class="nav-item dropdown" @mouseleave="dropDownUserExpanded = false"
                 @mouseover="dropDownUserExpanded = true">
              ...
              <div class="dropdown-menu dropdown-menu-right"
                   v-bind:class="{ show: dropDownUserExpanded }">
                                <span class="dropdown-item form-switch" @click="toggleDarkMode">
                                    <input :checked="darkMode" class="form-check-input m-0 mr-2" type="checkbox">
                                    {{ $t("dark_mode") }}
                                </span>
                <router-link :to="`/personal_settings`" class="dropdown-item"
                             @click.native="dropDownUserExpanded = false">
                ...
                <template v-for="link in links">
                  <router-link v-if="link.parent === 'settings'" :to="link.to"
          ...
          <div class="collapse navbar-collapse">
            <div class="d-flex flex-column flex-md-row flex-fill align-items-stretch align-items-md-center">
              <ul class="navbar-nav">
                <!-- overview -->
                <template v-for="link in links">
                  <li v-if="link.to === '/'" class="nav-item"
                ...
                <!-- sales_funnel -->
                <li class="nav-item dropdown" @mouseleave="showSalesFunnelMenu = false"
                    @mouseover="showSalesFunnelMenu = true">
                  ...
                  <ul class="dropdown-menu" v-bind:class="{show: showSalesFunnelMenu}">
                    <li v-for="link in links" v-if="link.parent === 'sales_funnel'"
                        @click="showSalesFunnelMenu=false">
                ...
                <!-- tasks -->
                <template v-for="link in links">
                  <li v-if="link.to === '/tasks'" class="nav-item"
                ...
                <!-- clients -->
                <li class="nav-item dropdown" @mouseleave="showClientMenu = false"
                    @mouseover="showClientMenu = true">
                  <a class="nav-link dropdown-toggle" href="javascript:void(0)">
                                        <span class="nav-link-icon d-md-none d-lg-inline-block mr-1">
                  ...
                  <ul class="dropdown-menu" v-bind:class="{show: showClientMenu}">
                    <li v-for="link in links" v-if="link.parent === 'clients'"
                        @click="showClientMenu=false">
                      <router-link :to="link.to" class="dropdown-item"
                                   exact-active-class="active">
                                                <span class="nav-link-icon d-md-none d-lg-inline-block mr-1">
                                                    <div v-html="link.icon"></div>
                ...
                <!-- financial -->
                <li class="nav-item dropdown" @mouseleave="showFinancialMenu = false"
                    @mouseover="showFinancialMenu = true">
                  <a class="nav-link dropdown-toggle" href="javascript:void(0)">
                                        <span class="nav-link-icon d-md-none d-lg-inline-block mr-1">
                  ...
                  <ul class="dropdown-menu" v-bind:class="{show: showFinancialMenu}">
                    <li v-for="link in links" v-if="link.parent === 'financial'"
                        @click="showFinancialMenu=false">
                      <router-link :to="link.to" class="dropdown-item"
                                   exact-active-class="active">
                                                <span class="nav-link-icon d-md-none d-lg-inline-block mr-1">
                                                    <div v-html="link.icon"></div>
                ...
                <!-- items -->
                <template v-for="link in links">
                  <li v-if="link.to === '/items'" class="nav-item"
