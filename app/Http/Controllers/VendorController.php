...
class VendorController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'email' => 'required|email|string|unique:vendors,email,NULL,NULL,tenant_id,' . auth()->user()->id,
    ...
    public function update($id, Request $request)
    {
        ...
        $request->validate([
            'name' => 'required|string',
            'email' => 'required|email|string|unique:vendors,email,' . $id . ',id,tenant_id,' . auth()->user()->id,
            'mobile' => 'nullable|string',
            'work' => 'nullable|string',
            'fax' => 'nullable|string',
            'website' => 'nullable|string',
